...
/**
 * Смена почты подтверждается дважды: паролем здесь и письмом на новый адрес.
 *
 * Пароль бережёт от смены чужими руками, письмо — от опечатки: адрес, до
 * которого не дошло письмо, входом так и не станет.
 */
...
/** Подтверждение нового адреса по ссылке из письма. */
